...
/*   Updated: 2024/12/08 22:08:56 by alaktari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static bool	player_in_door_cube_v(t_data *data, double rayangle, double *delta_x)
{
	int half_cube;
...
static bool	ray_hits_door_v(t_data *data, double rayangle, double *delta_x)
{
	int	half_cube;
...
bool	v_ray_to_door(t_data *data, double rayangle, double *delta_x)
{
	...
	if (data->in_door)
		...
		return (ray_hits_door_v(data, rayangle, delta_x));
	return (false);
}